Feature: Registration Functionality
  @registration_with_mandatory  # Passed
  ...
  @register_with_all_fields  # Passed
  ...
  @register_with_existing_email  # Passed
  ...
  @register_without_providing_data  # Passed
  ...
  @register_without_data_only_click_policy  # Passed
